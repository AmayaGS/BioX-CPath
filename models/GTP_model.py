...
import math
from torch_geometric.nn.dense import DenseGraphConv, dense_mincut_pool
from torch_geometric.utils import to_dense_adj


class GTP_Classifier(nn.Module):

    def __init__(self, n_class, n_features: int = 1024):
        super(GTP_Classifier, self).__init__()
        ...
        self.conv1 = DenseGraphConv(n_features, self.embed_dim)
    ...
    def forward(self, data, label):
        ...
        x = self.conv1(x, adj)
        cluster_assignment = self.pool1(x)

        x, adj, mc1, o1 = dense_mincut_pool(x, adj, cluster_assignment)
        b, _, _ = x.shape
        ...
        results_dict = {'logits': logits, 'Y_prob': Y_prob, 'mc1': mc1, 'o1': o1}
