...
from unet_utils_CAMELYON16 import CAMELYON16_save_patches
...
def main(args):
    ...
    CAMELYON16_save_patches(args.input_directory, args.mask_directory, args.results_directory, args.slide_level, args.patchsize, args.coverage)
...
if __name__ == "__main__":
    ...
    args.results_directory = r"C:\Users\Amaya\Documents\PhD\Data\Camelyon\CAMELYON16\data"
    args.slide_level = 4
    args.coverage = 0.3
    main(args)
...
# if __name__ == "__main__":
#     args = arg_parse()
#     args.input_directory = "/data/PublicDataSets/CAMELYON/CAMELYON16/images/"
#     args.mask_directory = "/data/PublicDataSets/CAMELYON/CAMELYON16/masks/"
#     args.results_directory = "/data/scratch/wpw030/CAMELYON16/data_5/"
#     args.slide_level = 3
#     args.coverage = 0.3
#     main(args)