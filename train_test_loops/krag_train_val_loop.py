...
def train_graph(graph_net, train_loader, val_loader, loss_fn, optimizer, logging_file_path, fold, n_classes, num_epochs,
                checkpoint, checkpoint_path="PATH_checkpoints"):
    since = time.time()
    best_val_acc = 0.
    best_val_AUC = 0.
    ...
    for epoch in range(num_epochs):
        train_loss, train_accuracy, class_correct, class_total = train_epoch(graph_net,
                                                                             train_loader,
                                                                             loss_fn,
                                                                             optimizer,
                                                                             n_classes)
        val_loss, val_accuracy, val_auc, conf_matrix, class_report = evaluate_model(graph_net,
                                                                                    val_loader,
                                                                                    loss_fn,
                                                                                    n_classes)
...
#
#     print('\nVal Set, val_loss: {:.4f}, AUC: {:.4f}, Accuracy: {:.4f}'.format(test_loss, test_auc, test_accuracy),
#           flush=True)
#
#     print(conf_matrix)
#
