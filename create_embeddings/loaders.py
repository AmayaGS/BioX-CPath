...
class histoDataset(Dataset):
    ...
    def __init__(self, df, transform, label, multistain):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            if self.multistain:
                ...
                return self.image_tensor, self.image_label, patient_id, filename, patch_name, coordinate
...
class Loaders:
        ...
        def slides_dataloader(self, df, ids, transform, slide_batch, num_workers, shuffle, collate, label, patient_id, multistain):
            ...
            for i, file in enumerate(ids):
                new_key = f'{file}'
                patient_subset = histoDataset(df[df[patient_id] == file], transform, label, multistain)
